...
from models.block import DownBlock, MidBlock, UpBlock
...
class VQVAE(nn.Module):
    ...
    def encode(self, x):
        ...
        out, quantize_losses, min_encoding_indices = self.quantize(out)
        
        return out, quantize_losses
    ...
    def forward(self, x):
        z, quantize_losses = self.encode(x)
        out = self.decode(z)
        return out, z, quantize_losses
